...
public class ConsensusPubSubWithSubmitKeyExample {
    ...
    public static void main(String[] args) throws TimeoutException, InterruptedException, HederaPreCheckStatusException {
        new ConsensusPubSubWithSubmitKeyExample(5, 2000).execute();
    }

    public void execute() throws TimeoutException, InterruptedException, HederaPreCheckStatusException {
     ...
     *
     */
    private void createTopicWithSubmitKey() throws TimeoutException, HederaPreCheckStatusException {
     ...
     */
    private void publishMessagesToTopic() throws TimeoutException, InterruptedException, HederaPreCheckStatusException {
        Random r = new Random();
