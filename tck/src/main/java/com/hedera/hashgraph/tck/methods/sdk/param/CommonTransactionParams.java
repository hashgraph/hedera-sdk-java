...
public class CommonTransactionParams extends JSONRPC2Param {
    ...
    public JSONRPC2Param parse(Map<String, Object> jrpcParams) throws ClassCastException {
        ...
        Optional<Long> validTransactionDuration = Optional.ofNullable((Long) jrpcParams.get("validTransactionDuration"));
        Optional<String> memo = Optional.ofNullable((String) jrpcParams.get("memo"));
        Optional<Boolean> regenerateTransactionId = Optional.ofNullable((Boolean) jrpcParams.get("regenerateTransactionId"));
