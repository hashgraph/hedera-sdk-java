...
dependencies.components {
    ...
    val grpcModule = listOf("io.helidon.grpc:io.grpc:3.2.1")
    ...
    withModule<RemoveDependenciesMetadataRule>("io.grpc:grpc-protobuf-lite") {
        params(
            grpcComponents + annotationLibraries
        )
    }
...
extraJavaModuleInfo {
    failOnMissingModuleInfo.set(false) // Only allow Jars with 'module-info' on all module paths
