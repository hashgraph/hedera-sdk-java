...
import org.hiero.sdk.java.SystemDeleteTransaction;
import org.hiero.sdk.java.SystemUndeleteTransaction;
...
public class SystemIntegrationTest {
    ...
    void allSystemTransactionsAreNotSupported() throws Exception {
        try (var testEnv = new IntegrationTestEnv(1)) {
            ...
            var fileId = Objects.requireNonNull(new FileCreateTransaction()
