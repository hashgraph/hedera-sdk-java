...
import static org.hiero.sdk.java.EntityIdHelper.getEvmAddressFromMirrorNodeAsync;

import java.util.Objects;
import java.util.concurrent.ExecutionException;
import org.hiero.sdk.java.AccountCreateTransaction;
import org.hiero.sdk.java.ContractCallQuery;
import org.hiero.sdk.java.ContractCreateTransaction;
import org.hiero.sdk.java.ContractDeleteTransaction;
import org.hiero.sdk.java.ContractExecuteTransaction;
import org.hiero.sdk.java.ContractFunctionParameters;
import org.hiero.sdk.java.ContractId;
...
import org.hiero.sdk.java.MirrorNodeContractCallQuery;
import org.hiero.sdk.java.MirrorNodeContractEstimateGasQuery;
            ...
            assertThatExceptionOfType(ExecutionException.class)
                    .isThrownBy(() -> {
                        new MirrorNodeContractEstimateGasQuery()
                                ...
                                .setGasLimit(100)
                                .setFunction(
                                        "addOwnerAndTransfer", new ContractFunctionParameters().addAddress(ADDRESS))
                                .execute(testEnv.client);
                    })
