...
import org.hiero.sdk.java.proto.TransactionGetRecordQuery;
...
public final class TransactionRecordQuery extends Query<TransactionRecord, TransactionRecordQuery> {
    ...
    @Override
    TransactionRecord mapResponse(Response response, AccountId nodeId, org.hiero.sdk.java.proto.Query request) {
    ...
    private List<TransactionRecord> mapRecordList(List<org.hiero.sdk.java.proto.TransactionRecord> protoRecordList) {
