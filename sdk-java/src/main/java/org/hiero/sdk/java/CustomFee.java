...
public abstract class CustomFee {
     ...
     */
    static CustomFee fromProtobufInner(org.hiero.sdk.java.proto.CustomFee customFee) {
    ...
    static CustomFee fromProtobuf(org.hiero.sdk.java.proto.CustomFee customFee) {
    ...
    public static CustomFee fromBytes(byte[] bytes) throws InvalidProtocolBufferException {
        return fromProtobuf(
                org.hiero.sdk.java.proto.CustomFee.parseFrom(bytes).toBuilder().build());
    }
     ...
     */
    abstract org.hiero.sdk.java.proto.CustomFee toProtobuf();
