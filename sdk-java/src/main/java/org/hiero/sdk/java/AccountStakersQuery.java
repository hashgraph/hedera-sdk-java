...
import org.hiero.sdk.java.proto.CryptoGetStakersQuery;
...
public final class AccountStakersQuery extends Query<List<ProxyStaker>, AccountStakersQuery> {
    ...
    @Override
    List<ProxyStaker> mapResponse(Response response, AccountId nodeId, org.hiero.sdk.java.proto.Query request) {
