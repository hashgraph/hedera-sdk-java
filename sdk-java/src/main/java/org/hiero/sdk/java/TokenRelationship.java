...
import org.hiero.sdk.java.proto.TokenFreezeStatus;
import org.hiero.sdk.java.proto.TokenKycStatus;
...
public class TokenRelationship {
     ...
     */
    static TokenRelationship fromProtobuf(org.hiero.sdk.java.proto.TokenRelationship tokenRelationship) {
    ...
    public static TokenRelationship fromBytes(byte[] bytes) throws InvalidProtocolBufferException {
        return fromProtobuf(org.hiero.sdk.java.proto.TokenRelationship.parseFrom(bytes).toBuilder()
                .build());
    }
     ...
     */
    org.hiero.sdk.java.proto.TokenRelationship toProtobuf() {
        return org.hiero.sdk.java.proto.TokenRelationship.newBuilder()
