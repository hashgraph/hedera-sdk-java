...
public class LiveHash {
     ...
     */
    protected static LiveHash fromProtobuf(org.hiero.sdk.java.proto.LiveHash liveHash) {
        return new LiveHash(
    ...
    public static LiveHash fromBytes(byte[] bytes) throws InvalidProtocolBufferException {
        return fromProtobuf(
                org.hiero.sdk.java.proto.LiveHash.parseFrom(bytes).toBuilder().build());
    }
     ...
     * @return                          the protobuf
     */
    protected org.hiero.sdk.java.proto.LiveHash toProtobuf() {
        var keyList = org.hiero.sdk.java.proto.KeyList.newBuilder();
        for (Key key : keys) {
            keyList.addKeys(key.toProtobufKey());
        }

        return org.hiero.sdk.java.proto.LiveHash.newBuilder()
