...
import org.hiero.sdk.java.proto.ConsensusUpdateTopicTransactionBody;
...
public final class TopicUpdateTransaction extends Transaction<TopicUpdateTransaction> {
     ...
     */
    TopicUpdateTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, org.hiero.sdk.java.proto.Transaction>> txs)
     ...
     */
    TopicUpdateTransaction(org.hiero.sdk.java.proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     *
     * @return {@link
     *         org.hiero.sdk.java.proto.ConsensusUpdateTopicTransactionBody}
     */
