...
import org.hiero.sdk.java.proto.ExchangeRateSet;
...
public final class TransactionReceipt {
    ...
    static TransactionReceipt fromProtobuf(
            org.hiero.sdk.java.proto.TransactionReceipt transactionReceipt,
            List<TransactionReceipt> duplicates,
            List<TransactionReceipt> children,
            @Nullable TransactionId transactionId) {
     ...
     * @return                          the new transaction receipt
     */
    public static TransactionReceipt fromProtobuf(org.hiero.sdk.java.proto.TransactionReceipt transactionReceipt) {
        return fromProtobuf(transactionReceipt, new ArrayList<>(), new ArrayList<>(), null);
    }

    static TransactionReceipt fromProtobuf(
            org.hiero.sdk.java.proto.TransactionReceipt transactionReceipt, @Nullable TransactionId transactionId) {
    ...
    public static TransactionReceipt fromBytes(byte[] bytes) throws InvalidProtocolBufferException {
        return fromProtobuf(org.hiero.sdk.java.proto.TransactionReceipt.parseFrom(bytes).toBuilder()
                .build());
    }
     ...
     */
    org.hiero.sdk.java.proto.TransactionReceipt toProtobuf() {
        var transactionReceiptBuilder = org.hiero.sdk.java.proto.TransactionReceipt.newBuilder()
                .setStatus(status.code)
                .setExchangeRate(ExchangeRateSet.newBuilder()
                        .setCurrentRate(org.hiero.sdk.java.proto.ExchangeRate.newBuilder()
                        ...
                        .setNextRate(org.hiero.sdk.java.proto.ExchangeRate.newBuilder()
