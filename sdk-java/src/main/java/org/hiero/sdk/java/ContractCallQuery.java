...
import org.hiero.sdk.java.proto.ContractCallLocalQuery;
...
public final class ContractCallQuery extends Query<ContractFunctionResult, ContractCallQuery> {
    ...
    @Override
    ContractFunctionResult mapResponse(Response response, AccountId nodeId, org.hiero.sdk.java.proto.Query request) {
