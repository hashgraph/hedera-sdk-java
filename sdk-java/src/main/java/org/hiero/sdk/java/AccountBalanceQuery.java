...
import org.hiero.sdk.java.proto.CryptoGetAccountBalanceQuery;
...
public final class AccountBalanceQuery extends Query<AccountBalance, AccountBalanceQuery> {
    ...
    @Override
    AccountBalance mapResponse(Response response, AccountId nodeId, org.hiero.sdk.java.proto.Query request) {
