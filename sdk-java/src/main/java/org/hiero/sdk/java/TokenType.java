...
public enum TokenType {
     ...
     */
    FUNGIBLE_COMMON(org.hiero.sdk.java.proto.TokenType.FUNGIBLE_COMMON),
    /**
     ...
     */
    NON_FUNGIBLE_UNIQUE(org.hiero.sdk.java.proto.TokenType.NON_FUNGIBLE_UNIQUE);

    final org.hiero.sdk.java.proto.TokenType code;
     ...
     */
    TokenType(org.hiero.sdk.java.proto.TokenType code) {
        this.code = code;
    }
     ...
     */
    static TokenType valueOf(org.hiero.sdk.java.proto.TokenType code) {
        return switch (code) {
    ...
    public org.hiero.sdk.java.proto.TokenType toProtobuf() {
        return this.code;
    }
}
