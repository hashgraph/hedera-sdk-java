...
public final class ContractNonceInfo {
     ...
     */
    static ContractNonceInfo fromProtobuf(org.hiero.sdk.java.proto.ContractNonceInfo contractNonceInfo) {
    ...
    public static ContractNonceInfo fromBytes(byte[] bytes) throws InvalidProtocolBufferException {
        return fromProtobuf(org.hiero.sdk.java.proto.ContractNonceInfo.parseFrom(bytes).toBuilder()
                .build());
    }
     ...
     */
    org.hiero.sdk.java.proto.ContractNonceInfo toProtobuf() {
        return org.hiero.sdk.java.proto.ContractNonceInfo.newBuilder()
