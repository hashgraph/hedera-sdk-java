...
import org.hiero.sdk.java.proto.ContractGetBytecodeQuery;
...
public final class ContractByteCodeQuery extends Query<ByteString, ContractByteCodeQuery> {
    ...
    @Override
    ByteString mapResponse(Response response, AccountId nodeId, org.hiero.sdk.java.proto.Query request) {
