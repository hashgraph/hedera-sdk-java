...
import org.hiero.sdk.java.proto.ContractGetInfoQuery;
...
public final class ContractInfoQuery extends Query<ContractInfo, ContractInfoQuery> {
    ...
    @Override
    ContractInfo mapResponse(Response response, AccountId nodeId, org.hiero.sdk.java.proto.Query request) {
