...
abstract class AbstractTokenTransferTransaction<T extends AbstractTokenTransferTransaction<T>> extends Transaction<T> {
     ...
     */
    AbstractTokenTransferTransaction(org.hiero.sdk.java.proto.TransactionBody txBody) {
        super(txBody);
    }
    ...
    protected ArrayList<org.hiero.sdk.java.TokenTransferList> sortTransfersAndBuild() {
        var transferLists = new ArrayList<org.hiero.sdk.java.TokenTransferList>();
        ...
        while (i < this.tokenTransfers.size() || j < this.nftTransfers.size()) {
            if (i < this.tokenTransfers.size() && j < this.nftTransfers.size()) {
                ...
                if (result == 0) {
                    transferLists.add(new org.hiero.sdk.java.TokenTransferList(
                            iTokenId,
                    ...
                    transferLists.add(
                            new org.hiero.sdk.java.TokenTransferList(jTokenId, null, null, this.nftTransfers.get(j++)));
                }
