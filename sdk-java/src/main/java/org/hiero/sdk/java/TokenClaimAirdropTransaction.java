...
import org.hiero.sdk.java.proto.TokenClaimAirdropTransactionBody;
...
public class TokenClaimAirdropTransaction extends PendingAirdropLogic<TokenClaimAirdropTransaction> {
     ...
     */
    TokenClaimAirdropTransaction(org.hiero.sdk.java.proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     *
     * @return {@link org.hiero.sdk.java.proto.TokenClaimAirdropTransactionBody}
     */
