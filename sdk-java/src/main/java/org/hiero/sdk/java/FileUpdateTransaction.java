...
import org.hiero.sdk.java.proto.FileUpdateTransactionBody;
...
public final class FileUpdateTransaction extends Transaction<FileUpdateTransaction> {
     ...
     */
    FileUpdateTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, org.hiero.sdk.java.proto.Transaction>> txs)
     ...
     */
    FileUpdateTransaction(org.hiero.sdk.java.proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     *
     * @return {@link org.hiero.sdk.java.proto.FileUpdateTransactionBody builder }
     */
