...
import org.hiero.sdk.java.proto.ServiceEndpoint;
...
public class NodeAddress implements Cloneable {
     ...
     * @return                          the new node
     */
    static NodeAddress fromProtobuf(org.hiero.sdk.java.proto.NodeAddress nodeAddress) {
     ...
     */
    org.hiero.sdk.java.proto.NodeAddress toProtobuf() {
        var builder = org.hiero.sdk.java.proto.NodeAddress.newBuilder().setNodeId(nodeId);
