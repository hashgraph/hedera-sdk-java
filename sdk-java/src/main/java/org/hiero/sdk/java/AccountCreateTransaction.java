...
import org.hiero.sdk.java.proto.CryptoCreateTransactionBody;
...
public final class AccountCreateTransaction extends Transaction<AccountCreateTransaction> {
     ...
     */
    AccountCreateTransaction(org.hiero.sdk.java.proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     *
     * @return {@link org.hiero.sdk.java.proto.CryptoCreateTransactionBody}
     */
