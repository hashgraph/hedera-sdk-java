...
public class StakingInfo {
    ...
    static StakingInfo fromProtobuf(org.hiero.sdk.java.proto.StakingInfo info) {
    ...
    public static StakingInfo fromBytes(byte[] bytes) throws InvalidProtocolBufferException {
        return fromProtobuf(org.hiero.sdk.java.proto.StakingInfo.parseFrom(bytes));
    }

    org.hiero.sdk.java.proto.StakingInfo toProtobuf() {
        var builder = org.hiero.sdk.java.proto.StakingInfo.newBuilder()
