...
import org.hiero.sdk.java.proto.GrantedTokenAllowance;
...
public class TokenAllowance {
     ...
     */
    static TokenAllowance fromProtobuf(org.hiero.sdk.java.proto.TokenAllowance allowanceProto) {
    ...
    public static TokenAllowance fromBytes(byte[] bytes) throws InvalidProtocolBufferException {
        return fromProtobuf(org.hiero.sdk.java.proto.TokenAllowance.parseFrom(Objects.requireNonNull(bytes)));
    }
     ...
     */
    org.hiero.sdk.java.proto.TokenAllowance toProtobuf() {
        var builder = org.hiero.sdk.java.proto.TokenAllowance.newBuilder().setAmount(amount);
        if (tokenId != null) {
