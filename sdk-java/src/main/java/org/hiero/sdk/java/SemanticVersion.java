...
public class SemanticVersion {
     ...
     */
    protected static SemanticVersion fromProtobuf(org.hiero.sdk.java.proto.SemanticVersion version) {
    ...
    public static SemanticVersion fromBytes(byte[] bytes) throws InvalidProtocolBufferException {
        return fromProtobuf(org.hiero.sdk.java.proto.SemanticVersion.parseFrom(bytes));
    }
     ...
     */
    protected org.hiero.sdk.java.proto.SemanticVersion toProtobuf() {
        return org.hiero.sdk.java.proto.SemanticVersion.newBuilder()
                .setMajor(major)
                .setMinor(minor)
                .setPatch(patch)
                .build();
