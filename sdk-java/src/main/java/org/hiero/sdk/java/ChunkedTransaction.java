...
abstract class ChunkedTransaction<T extends ChunkedTransaction<T>> extends Transaction<T> {
     ...
     */
    ChunkedTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, org.hiero.sdk.java.proto.Transaction>> txs)
     ...
     */
    ChunkedTransaction(org.hiero.sdk.java.proto.TransactionBody txBody) {
        super(txBody);
    }
    ...
    public CompletableFuture<List<TransactionResponse>> executeAllAsync(Client client, Duration timeoutPerChunk) {
        ...
        CompletableFuture<List<org.hiero.sdk.java.TransactionResponse>> future =
