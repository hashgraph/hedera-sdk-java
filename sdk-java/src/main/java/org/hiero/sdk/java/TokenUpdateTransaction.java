...
import org.hiero.sdk.java.proto.TokenUpdateTransactionBody;
...
public class TokenUpdateTransaction extends Transaction<TokenUpdateTransaction> {
     ...
     */
    TokenUpdateTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, org.hiero.sdk.java.proto.Transaction>> txs)
     ...
     */
    TokenUpdateTransaction(org.hiero.sdk.java.proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     *
     * @return {@link
     *         org.hiero.sdk.java.proto.TokenUpdateTransactionBody}
     */
