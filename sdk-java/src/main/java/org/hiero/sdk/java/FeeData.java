...
public class FeeData implements Cloneable {
     ...
     */
    static FeeData fromProtobuf(org.hiero.sdk.java.proto.FeeData feeData) {
        return new FeeData()
    ...
    public static FeeData fromBytes(byte[] bytes) throws InvalidProtocolBufferException {
        return fromProtobuf(
                org.hiero.sdk.java.proto.FeeData.parseFrom(bytes).toBuilder().build());
    }
     ...
     * {@link org.hiero.sdk.java.FeeDataType}
     *
     ...
     * @return                          the protobuf
     */
    org.hiero.sdk.java.proto.FeeData toProtobuf() {
        var builder = org.hiero.sdk.java.proto.FeeData.newBuilder().setSubType(type.code);
        if (nodeData != null) {
