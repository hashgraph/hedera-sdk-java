...
public class TransactionFeeSchedule implements Cloneable {
     ...
     */
    static TransactionFeeSchedule fromProtobuf(org.hiero.sdk.java.proto.TransactionFeeSchedule transactionFeeSchedule) {
    ...
    public static TransactionFeeSchedule fromBytes(byte[] bytes) throws InvalidProtocolBufferException {
        return fromProtobuf(org.hiero.sdk.java.proto.TransactionFeeSchedule.parseFrom(bytes).toBuilder()
                .build());
    }
