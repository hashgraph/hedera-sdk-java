...
public class AccountAllowanceApproveTransaction extends Transaction<AccountAllowanceApproveTransaction> {
     ...
     */
    AccountAllowanceApproveTransaction(org.hiero.sdk.java.proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     *
     * @return {@link org.hiero.sdk.java.proto.CryptoApproveAllowanceTransactionBody builder }
     */
