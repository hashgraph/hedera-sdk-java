...
public abstract class Key {
     ...
     */
    static Key fromProtobufKey(org.hiero.sdk.java.proto.Key key) {
     ...
     */
    abstract org.hiero.sdk.java.proto.Key toProtobufKey();
    ...
    public static Key fromBytes(byte[] bytes) throws InvalidProtocolBufferException {
        return fromProtobufKey(org.hiero.sdk.java.proto.Key.parseFrom(bytes));
    }
}
