...
import static org.hiero.sdk.java.Key.fromBytes;
...
import org.hiero.sdk.java.proto.ThresholdKey;
...
class KeyTest {
    ...
    void fromProtoKeyKeyList() {
        ...
        // when
        var cut = org.hiero.sdk.java.Key.fromProtobufKey(protoKey);

        // then
        assertThat(cut.getClass()).isEqualTo(org.hiero.sdk.java.KeyList.class);

        var keyList = (org.hiero.sdk.java.KeyList) cut;
    ...
    void fromProtoKeyThresholdKey() {
        ...
        var thresholdKey = (org.hiero.sdk.java.KeyList) cut;
    ...
    void throwsUnsupportedKey() {
        ...
        assertThatExceptionOfType(IllegalStateException.class)
                .isThrownBy(() -> org.hiero.sdk.java.Key.fromProtobufKey(protoKey));
    }
    ...
    void keyListMethods() {
        ...
        var keyList = org.hiero.sdk.java.KeyList.withThreshold(1);
        keyList.add(key1);
        ...
        arr = new org.hiero.sdk.java.Key[] {null, null, null};
        keyList.toArray(arr);
        assertThat(arr[0]).isEqualTo(key1);
        assertThat(arr[1]).isEqualTo(key2);
        assertThat(arr[2]).isEqualTo(key3);
