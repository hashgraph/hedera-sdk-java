...
import org.hiero.sdk.java.Executable.GrpcRequest;
...
class ExecutableTest {
    ...
    void successfulExecute() throws PrecheckStatusException, TimeoutException {
        ...
        var tx = new DummyTransaction() {
            ...
            TransactionResponse mapResponse(
                    org.hiero.sdk.java.proto.TransactionResponse response,
                    AccountId nodeId,
        ...
        var txResp = org.hiero.sdk.java.proto.TransactionResponse.newBuilder()
                .setNodeTransactionPrecheckCode(ResponseCodeEnum.OK)
                .build();

        tx.blockingUnaryCall = (grpcRequest) -> txResp;
        org.hiero.sdk.java.TransactionResponse resp = (org.hiero.sdk.java.TransactionResponse) tx.execute(client);
    ...
    void executeQueryDelay() throws PrecheckStatusException, TimeoutException {
        ...
        var tx = new DummyQuery() {
            @Override
            Status mapResponseStatus(org.hiero.sdk.java.proto.Response response) {
        ...
        var receipt = org.hiero.sdk.java.proto.TransactionReceipt.newBuilder()
                .setStatus(ResponseCodeEnum.OK)
                .build();
        var receiptResp = org.hiero.sdk.java.proto.TransactionGetReceiptResponse.newBuilder()
                .setReceipt(receipt)
                .build();
    ...
    void executeUserError() throws PrecheckStatusException, TimeoutException {
        ...
        var tx = new DummyTransaction() {
            @Override
            Status mapResponseStatus(org.hiero.sdk.java.proto.TransactionResponse response) {
    ...
    static class DummyTransaction<T extends Transaction<T>>
        ...
        @Nullable
        @Override
        org.hiero.sdk.java.proto.Transaction makeRequest() {
            return null;
        }
        ...
        @Nullable
        @Override
        MethodDescriptor<org.hiero.sdk.java.proto.Transaction, org.hiero.sdk.java.proto.TransactionResponse>
                getMethodDescriptor() {
            return null;
        }
    ...
    static class DummyQuery extends Query<TransactionReceipt, TransactionReceiptQuery> {
        ...
        @Override
        TransactionReceipt mapResponse(Response response, AccountId nodeId, org.hiero.sdk.java.proto.Query request) {
            return null;
        }
