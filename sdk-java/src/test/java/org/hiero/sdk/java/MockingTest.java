...
import org.hiero.sdk.java.proto.AccountID;
import org.hiero.sdk.java.proto.CryptoGetAccountBalanceResponse;
...
import org.hiero.sdk.java.proto.TransactionGetRecordResponse;
import org.hiero.sdk.java.proto.TransactionReceipt;
import org.hiero.sdk.java.proto.TransactionRecord;
...
public class MockingTest {
    ...
    void shouldRetryExceptionallyFunctionsCorrectlyForPlatformNotActiveGetReceipt(String sync) throws Exception {
        ...
        service.buffer.enqueueResponse(TestResponse.transaction(org.hiero.sdk.java.Status.PLATFORM_NOT_ACTIVE));
        service.buffer.enqueueResponse(TestResponse.transactionOk());

        org.hiero.sdk.java.TransactionResponse transactionResponse;
        if (sync.equals("sync")) {
        ...
        service.buffer
                .enqueueResponse(TestResponse.query(Response.newBuilder()
                        .setTransactionGetReceipt(TransactionGetReceiptResponse.newBuilder()
                                ...
                                .build())
                        .build()))
                .enqueueResponse(TestResponse.receipt(org.hiero.sdk.java.Status.PLATFORM_NOT_ACTIVE))
    ...
    void contractCreateFlowFunctions(String versionToTest, String stakeType) throws Throwable {
        ...
        var transactions = new ArrayList<org.hiero.sdk.java.Transaction<?>>();
        for (var request : fileService.buffer.transactionRequestsReceived) {
            transactions.add(org.hiero.sdk.java.Transaction.fromBytes(request.toByteArray()));
        }
        transactions.add(org.hiero.sdk.java.Transaction.fromBytes(
    ...
    void hitsClientMaxAttemptsCorrectly(org.hiero.sdk.java.Status status, String sync) throws Exception {
        var service = new TestCryptoService();
    ...
    void canCancelExecuteAsync() throws Exception {
        ...
        var noReceiptResponse = TestResponse.query(Response.newBuilder()
                .setTransactionGetReceipt(TransactionGetReceiptResponse.newBuilder()
                        .setHeader(ResponseHeader.newBuilder()
                                .setNodeTransactionPrecheckCode(org.hiero.sdk.java.Status.RECEIPT_NOT_FOUND.code)))
                .build());
