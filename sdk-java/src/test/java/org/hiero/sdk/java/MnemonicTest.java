...
import org.hiero.sdk.java.utils.Bip32Utils;
...
public class MnemonicTest {
    private static final String MNEMONIC_LEGACY_V1_STRING =
    ...
    private static final String MNEMONIC_LEGACY_V2_STRING =
    ...
    private static final String MNEMONIC_24_WORD_STRING =
    ...
    private static final String MNEMONIC_12_WORD_STRING =
    ...
    void shortWordList() {
        assertThatExceptionOfType(BadMnemonicException.class)
                .isThrownBy(() -> Mnemonic.fromWords(Arrays.asList("lorem", "ipsum", "dolor")))
                .satisfies(error -> {
    ...
    void longWordList() {
        assertThatExceptionOfType(BadMnemonicException.class)
                .isThrownBy(() -> Mnemonic.fromWords(Arrays.asList(
                        "lorem",
                        "ipsum",
                        "dolor",
                        "ramp",
    ...
    void toStandardED25519PrivateKeyShouldFailWhenIndexIsPreHardened() throws BadMnemonicException {
        ...
        assertThatExceptionOfType(IllegalArgumentException.class)
                .isThrownBy(() -> mnemonic.toStandardEd25519PrivateKey("", hardenedIndex))
    ...
    void toStandardECDSAsecp256k1PrivateKey() throws BadMnemonicException {
        ...
        // Chain m/44'/3030'/0'/0/2147483647'; Passphrase "some pass"
        PrivateKey key6 =
                mnemonic.toStandardECDSAsecp256k1PrivateKey("some pass", Bip32Utils.toHardenedIndex(2147483647));
    ...
    @Test
    @DisplayName(
            "Mnemonic.toStandardECDSAsecp256k1PrivateKeyCustomDerivationPath() with custom derivation path invalid inputs vector")
    ...
    @Test
    @DisplayName(
            "Mnemonic.toStandardECDSAsecp256k1PrivateKeyCustomDerivationPath() with custom derivation path test vector")
