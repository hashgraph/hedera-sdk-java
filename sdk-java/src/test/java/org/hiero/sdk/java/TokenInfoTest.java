    ...
    */
    ...
    void toProtobuf() {
        ...
        assertThat(tokenInfoProto.getTokenInfo().getTokenType())
                .isEqualTo(org.hiero.sdk.java.proto.TokenType.valueOf(testTokenType.name()));
        assertThat(tokenInfoProto.getTokenInfo().getSupplyType())
                .isEqualTo(org.hiero.sdk.java.proto.TokenSupplyType.valueOf(testTokenSupplyType.name()));
