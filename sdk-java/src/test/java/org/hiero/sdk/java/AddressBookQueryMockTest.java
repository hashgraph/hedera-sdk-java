...
import org.hiero.sdk.java.proto.mirror.NetworkServiceGrpc;
...
class AddressBookQueryMockTest {
    ...
    void addressBookQueryWorks(String executeVersion) throws Throwable {
        addressBookServiceStub.requests.add(org.hiero.sdk.java.proto.mirror.AddressBookQuery.newBuilder()
                .setFileId(FileId.ADDRESS_BOOK.toProtobuf())
                .setLimit(3)
                .build());
        addressBookServiceStub.responses.add(new org.hiero.sdk.java.NodeAddress()
    ...
    private static class AddressBookQueryStub extends NetworkServiceGrpc.NetworkServiceImplBase {
        ...
        private final Queue<org.hiero.sdk.java.proto.mirror.AddressBookQuery> requests = new ArrayDeque<>();
        private final Queue<Object> responses = new ArrayDeque<>();

        @Override
        public void getNodes(
                org.hiero.sdk.java.proto.mirror.AddressBookQuery addressBookQuery,
                StreamObserver<org.hiero.sdk.java.proto.NodeAddress> streamObserver) {
            ...
            while (!responses.isEmpty()) {
                ...
                streamObserver.onNext((org.hiero.sdk.java.proto.NodeAddress) response);
            }
