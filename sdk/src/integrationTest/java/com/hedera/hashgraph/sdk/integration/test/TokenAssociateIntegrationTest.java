...
class TokenAssociateIntegrationTest {
    ...
    void canAssociateAccountWithToken() throws Exception {
        ...
        assertThat(info.tokenRelationships.get(tokenId).decimals).isEqualTo(tokenDecimals);

        testEnv.close(tokenId, accountId, key);
    }

    @Test
    @DisplayName("Can associate contract with token")
    void canAssociateContractWithToken() throws Exception {
