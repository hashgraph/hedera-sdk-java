...
public class MockingTest {
    ...
    void shouldRetryExceptionallyFunctionsCorrectlyForPlatformNotActiveGetReceipt(String sync) throws Exception {
        ...
        service.buffer.enqueueResponse(TestResponse.transaction(org.hiero.sdk.Status.PLATFORM_NOT_ACTIVE));
        service.buffer.enqueueResponse(TestResponse.transactionOk());

        org.hiero.sdk.TransactionResponse transactionResponse;
        if (sync.equals("sync")) {
        ...
        service.buffer
                .enqueueResponse(TestResponse.query(Response.newBuilder()
                        .setTransactionGetReceipt(TransactionGetReceiptResponse.newBuilder()
                                ...
                                .build())
                        .build()))
                .enqueueResponse(TestResponse.receipt(org.hiero.sdk.Status.PLATFORM_NOT_ACTIVE))
    ...
    void contractCreateFlowFunctions(String versionToTest, String stakeType) throws Throwable {
        ...
        var transactions = new ArrayList<org.hiero.sdk.Transaction<?>>();
        for (var request : fileService.buffer.transactionRequestsReceived) {
            transactions.add(org.hiero.sdk.Transaction.fromBytes(request.toByteArray()));
        }
        transactions.add(org.hiero.sdk.Transaction.fromBytes(
    ...
    void hitsClientMaxAttemptsCorrectly(org.hiero.sdk.Status status, String sync) throws Exception {
        var service = new TestCryptoService();
