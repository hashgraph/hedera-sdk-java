...
public class ECDSAPublicKeyTest {
    ...
    void toEvmAddress() {
        ...
        String expectedEvmAddress = "0xd8eb8db03c699faa3f47adcdcd2ae91773b10f8b";

        PrivateKey privateKey = PrivateKey.fromStringECDSA(privateKeyString);
        PublicKeyECDSA key = (PublicKeyECDSA) privateKey.getPublicKey();

        assertThat(key.toEvmAddress()).isEqualTo(expectedEvmAddress);
    }
}
