...
class KeystoreTest {
    ...
    void keystoreFromStream() throws IOException {
        ...
        final PrivateKey privateKey = keystore.getEd25519();
    ...
    void keystoreToStream() throws IOException {
        final PrivateKey privateKey = PrivateKey.fromString(testKeyStr);
        ...
        final PrivateKey privateKey2 = keystore2.getEd25519();
