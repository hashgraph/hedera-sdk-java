...
class HederaKeyTest {
	...
	static void initAll() {
		...
		hederaKeyList.addKey(new HederaKeyPair(KeyType.ED25519, keyBytes));
	}
	...
	private static Stream<Arguments> keyInit() {
		return Stream.of(
			Arguments.of(new HederaKeyPair(KeyType.ECDSA384, keyBytes), KeyType.ECDSA384, ""),
			Arguments.of(new HederaKeyPair(KeyType.RSA3072, keyBytes), KeyType.RSA3072, ""),
			Arguments.of(new HederaKeyPair(KeyType.ED25519, keyBytes), KeyType.ED25519, ""),
			Arguments.of(new HederaKeyPair(KeyType.ECDSA384, keyBytes, description), KeyType.ECDSA384, description),
			Arguments.of(new HederaKeyPair(KeyType.RSA3072, keyBytes, description), KeyType.RSA3072, description),
			Arguments.of(new HederaKeyPair(KeyType.ED25519, keyBytes, description), KeyType.ED25519, description)
		);
	}
