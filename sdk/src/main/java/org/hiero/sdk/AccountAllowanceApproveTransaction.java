...
public class AccountAllowanceApproveTransaction extends Transaction<AccountAllowanceApproveTransaction> {
     ...
     */
    AccountAllowanceApproveTransaction(org.hiero.sdk.proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     *
     * @return {@link org.hiero.sdk.proto.CryptoApproveAllowanceTransactionBody builder }
     */
