 ...
 * None
 */
public class TokenUnfreezeTransaction extends org.hiero.sdk.Transaction<TokenUnfreezeTransaction> {
    @Nullable
     ...
     */
    TokenUnfreezeTransaction(org.hiero.sdk.proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
