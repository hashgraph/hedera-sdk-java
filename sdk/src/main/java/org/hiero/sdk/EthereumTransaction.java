...
import org.hiero.sdk.proto.EthereumTransactionBody;
...
public class EthereumTransaction extends Transaction<EthereumTransaction> {
    ...
    EthereumTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, org.hiero.sdk.proto.Transaction>> txs)
            throws InvalidProtocolBufferException {
        super(txs);
        initFromTransactionBody();
    }

    EthereumTransaction(org.hiero.sdk.proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
