...
import com.hiero.sdk.proto.ConsensusCreateTopicTransactionBody;
...
public final class TopicCreateTransaction extends Transaction<TopicCreateTransaction> {
     ...
     */
    TopicCreateTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, com.hiero.sdk.proto.Transaction>> txs) throws InvalidProtocolBufferException {
        super(txs);
     ...
     */
    TopicCreateTransaction(com.hiero.sdk.proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     *
     * @return {@link
     *         com.hiero.sdk.proto.ConsensusCreateTopicTransactionBody}
     */
