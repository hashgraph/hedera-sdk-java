...
public final class FileCreateTransaction extends Transaction<FileCreateTransaction> {
     ...
     */
    FileCreateTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, com.hiero.sdk.proto.Transaction>> txs) throws InvalidProtocolBufferException {
        super(txs);
     ...
     */
    FileCreateTransaction(com.hiero.sdk.proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     * {@link com.hiero.sdk.KeyList} and pass that here.
     *
     ...
     * with {@link com.hiero.sdk.Status#TRANSACTION_OVERSIZE}.
     *
     ...
     *
     * @return {@link com.hiero.sdk.proto.FileCreateTransactionBody builder}
     */
