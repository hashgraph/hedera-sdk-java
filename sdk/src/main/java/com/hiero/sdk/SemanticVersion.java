...
public class SemanticVersion {
     ...
     */
    protected static SemanticVersion fromProtobuf(com.hiero.sdk.proto.SemanticVersion version) {
    ...
    public static SemanticVersion fromBytes(byte[] bytes) throws InvalidProtocolBufferException {
        return fromProtobuf(com.hiero.sdk.proto.SemanticVersion.parseFrom(bytes));
    }
     ...
     */
    protected com.hiero.sdk.proto.SemanticVersion toProtobuf() {
        return com.hiero.sdk.proto.SemanticVersion.newBuilder()
            .setMajor(major)
            .setMinor(minor)
            .setPatch(patch)
            .build();
