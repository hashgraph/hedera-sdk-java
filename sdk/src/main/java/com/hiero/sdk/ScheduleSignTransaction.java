...
import com.hiero.sdk.proto.ScheduleSignTransactionBody;
...
public final class ScheduleSignTransaction extends Transaction<ScheduleSignTransaction> {
     ...
     */
    ScheduleSignTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, com.hiero.sdk.proto.Transaction>> txs) throws InvalidProtocolBufferException {
        super(txs);
     ...
     *
     * @return {@link
     *         com.hiero.sdk.proto.ScheduleSignTransactionBody
     *         builder }
     */
