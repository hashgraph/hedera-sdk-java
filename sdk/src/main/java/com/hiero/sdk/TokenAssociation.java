...
public class TokenAssociation {
    ...
    public static TokenAssociation fromBytes(byte[] bytes) throws InvalidProtocolBufferException {
        return fromProtobuf(com.hiero.sdk.proto.TokenAssociation.parseFrom(bytes));
    }
     ...
     */
    com.hiero.sdk.proto.TokenAssociation toProtobuf() {
        return com.hiero.sdk.proto.TokenAssociation.newBuilder()
