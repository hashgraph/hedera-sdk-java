...
abstract class ChunkedTransaction<T extends ChunkedTransaction<T>> extends Transaction<T> {
     ...
     */
    ChunkedTransaction(com.hiero.sdk.proto.TransactionBody txBody) {
        super(txBody);
    }
    ...
    @Override
    public CompletableFuture<com.hiero.sdk.TransactionResponse> executeAsync(Client client, Duration timeoutPerChunk) {
