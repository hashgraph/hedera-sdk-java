...
public class TokenRevokeKycTransaction extends com.hiero.sdk.Transaction<TokenRevokeKycTransaction> {
     ...
     */
    TokenRevokeKycTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, com.hiero.sdk.proto.Transaction>> txs) throws InvalidProtocolBufferException {
        super(txs);
