...
public class TokenUpdateTransaction extends Transaction<TokenUpdateTransaction> {
     ...
     */
    TokenUpdateTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, com.hiero.sdk.proto.Transaction>> txs) throws InvalidProtocolBufferException {
        super(txs);
     ...
     */
    TokenUpdateTransaction(com.hiero.sdk.proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     *
     * @return {@link
     *         com.hiero.sdk.proto.TokenUpdateTransactionBody}
     */
