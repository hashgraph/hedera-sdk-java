...
import com.hiero.sdk.proto.ScheduleCreateTransactionBody;
...
public final class ScheduleCreateTransaction extends Transaction<ScheduleCreateTransaction> {
     ...
     */
    ScheduleCreateTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, com.hiero.sdk.proto.Transaction>> txs) throws InvalidProtocolBufferException {
        super(txs);
     ...
     *
     * @return {@link com.hiero.sdk.proto.ScheduleCreateTransactionBody builder }
     */
