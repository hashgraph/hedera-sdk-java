...
import com.hiero.sdk.proto.FileUpdateTransactionBody;
...
public final class FileUpdateTransaction extends Transaction<FileUpdateTransaction> {
     ...
     */
    FileUpdateTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, com.hiero.sdk.proto.Transaction>> txs) throws InvalidProtocolBufferException {
        super(txs);
     ...
     */
    FileUpdateTransaction(com.hiero.sdk.proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     * @return {@code this}
     * @see #setContents(String) - Overload that takes a String.
     ...
     *
     * @return {@link com.hiero.sdk.proto.FileUpdateTransactionBody builder }
     */
