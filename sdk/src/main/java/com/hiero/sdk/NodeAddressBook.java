...
public class NodeAddressBook {
     ...
     */
    static NodeAddressBook fromProtobuf(com.hiero.sdk.proto.NodeAddressBook book) {
    ...
    public static NodeAddressBook fromBytes(ByteString bytes) throws InvalidProtocolBufferException {
        return fromProtobuf(com.hiero.sdk.proto.NodeAddressBook.parseFrom(bytes));
    }
     ...
     */
    com.hiero.sdk.proto.NodeAddressBook toProtobuf() {
        var builder = com.hiero.sdk.proto.NodeAddressBook.newBuilder();
