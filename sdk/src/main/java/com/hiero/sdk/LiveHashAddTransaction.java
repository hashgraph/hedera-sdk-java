...
import com.hiero.sdk.proto.CryptoAddLiveHashTransactionBody;
...
public final class LiveHashAddTransaction extends Transaction<LiveHashAddTransaction> {
     ...
     */
    LiveHashAddTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, com.hiero.sdk.proto.Transaction>> txs) throws InvalidProtocolBufferException {
        super(txs);
