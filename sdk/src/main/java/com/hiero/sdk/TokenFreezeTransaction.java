...
import com.hiero.sdk.proto.TokenFreezeAccountTransactionBody;
 ...
 */
public class TokenFreezeTransaction extends com.hiero.sdk.Transaction<TokenFreezeTransaction> {
    @Nullable
     ...
     */
    TokenFreezeTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, com.hiero.sdk.proto.Transaction>> txs) throws InvalidProtocolBufferException {
        super(txs);
     ...
     */
    TokenFreezeTransaction(com.hiero.sdk.proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     *
     * @return {@link
     *         com.hiero.sdk.proto.TokenFreezeAccountTransactionBody}
     */
