...
import com.hiero.sdk.proto.TokenGrantKycTransactionBody;
 ...
 */
public class TokenGrantKycTransaction extends com.hiero.sdk.Transaction<TokenGrantKycTransaction> {
    @Nullable
     ...
     */
    TokenGrantKycTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, com.hiero.sdk.proto.Transaction>> txs) throws InvalidProtocolBufferException {
        super(txs);
     ...
     */
    TokenGrantKycTransaction(com.hiero.sdk.proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     *
     * @return {@link
     *         com.hiero.sdk.proto.TokenGrantKycTransactionBody}
     */
