...
public class AssessedCustomFee {
     ...
     */
    static AssessedCustomFee fromProtobuf(com.hiero.sdk.proto.AssessedCustomFee assessedCustomFee) {
     ...
     *
     * @return {@link com.hiero.sdk.proto.AssessedCustomFee}
     */
    com.hiero.sdk.proto.AssessedCustomFee toProtobuf() {
        var builder = com.hiero.sdk.proto.AssessedCustomFee.newBuilder().setAmount(amount);
        if (tokenId != null) {
