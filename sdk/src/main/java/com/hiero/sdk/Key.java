...
public abstract class Key {
     ...
     */
    static Key fromProtobufKey(com.hiero.sdk.proto.Key key) {
     ...
     */
    abstract com.hiero.sdk.proto.Key toProtobufKey();
    ...
    public static Key fromBytes(byte[] bytes) throws InvalidProtocolBufferException {
        return fromProtobufKey(com.hiero.sdk.proto.Key.parseFrom(bytes));
    }
}
