...
import com.hiero.sdk.proto.TokenDeleteTransactionBody;
 ...
 */
public class TokenDeleteTransaction extends com.hiero.sdk.Transaction<TokenDeleteTransaction> {
    @Nullable
     ...
     */
    TokenDeleteTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, com.hiero.sdk.proto.Transaction>> txs) throws InvalidProtocolBufferException {
        super(txs);
     ...
     */
    TokenDeleteTransaction(com.hiero.sdk.proto.TransactionBody txBody) {
        super(txBody);
        initFromTransactionBody();
    }
     ...
     *
     * @return {@link
     *         com.hiero.sdk.proto.TokenDeleteTransactionBody}
     */
