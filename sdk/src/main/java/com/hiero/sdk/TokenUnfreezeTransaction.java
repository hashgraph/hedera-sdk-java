...
public class TokenUnfreezeTransaction extends com.hiero.sdk.Transaction<TokenUnfreezeTransaction> {
     ...
     */
    TokenUnfreezeTransaction(LinkedHashMap<TransactionId, LinkedHashMap<AccountId, com.hiero.sdk.proto.Transaction>> txs) throws InvalidProtocolBufferException {
        super(txs);
