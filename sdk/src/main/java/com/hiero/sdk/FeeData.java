...
public class FeeData implements Cloneable {
     ...
     */
    static FeeData fromProtobuf(com.hiero.sdk.proto.FeeData feeData) {
        return new FeeData()
    ...
    public static FeeData fromBytes(byte[] bytes) throws InvalidProtocolBufferException {
        return fromProtobuf(com.hiero.sdk.proto.FeeData.parseFrom(bytes).toBuilder().build());
    }
     ...
     * @return                          the protobuf
     */
    com.hiero.sdk.proto.FeeData toProtobuf() {
        var builder = com.hiero.sdk.proto.FeeData.newBuilder().setSubType(type.code);
        if (nodeData != null) {
