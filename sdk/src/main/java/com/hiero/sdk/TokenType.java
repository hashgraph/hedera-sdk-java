...
public enum TokenType {
     ...
     */
    FUNGIBLE_COMMON(com.hiero.sdk.proto.TokenType.FUNGIBLE_COMMON),
    /**
     ...
     */
    NON_FUNGIBLE_UNIQUE(com.hiero.sdk.proto.TokenType.NON_FUNGIBLE_UNIQUE);

    final com.hiero.sdk.proto.TokenType code;
     ...
     */
    TokenType(com.hiero.sdk.proto.TokenType code) {
        this.code = code;
    }
     ...
     */
    static TokenType valueOf(com.hiero.sdk.proto.TokenType code) {
        return switch (code) {
    ...
    public com.hiero.sdk.proto.TokenType toProtobuf() {
        return this.code;
    }
}
