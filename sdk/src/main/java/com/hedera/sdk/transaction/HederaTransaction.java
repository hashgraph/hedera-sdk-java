...
//		transactionProtobuf.setSigs(this.signatureList.getProtobuf());
	 ...
	 * @param node the node to send the transaction to
	...
	public HederaTransaction(HederaTransactionAndQueryDefaults txQueryDefaults, long queryFee, HederaNode node) throws Exception {
		...
		//paying signature
		sigsForTransaction.addSignature(txQueryDefaults.payingKeyPair.getPublicKey(), txQueryDefaults.payingKeyPair.signMessage(transferBody.toByteArray()));
