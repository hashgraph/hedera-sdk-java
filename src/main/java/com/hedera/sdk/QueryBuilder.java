...
public abstract class QueryBuilder<Resp> extends ValidatedBuilder {
    ...
    public final Resp execute(Client client) {
        return mapResponse.apply(
                ClientCalls.blockingUnaryCall(newClientCall(client), inner.build()));
    }

    public final void executeAsync(
            Client client, Function<Resp, Void> onSuccess, Function<Throwable, Void> onError) {
        ClientCalls.asyncUnaryCall(
                newClientCall(client),
                inner.build(),
                new ResponseObserver(mapResponse.andThen(onSuccess), onError));
    }

    public final Future<Resp> executeFuture(Client client) {
        return Futures.lazyTransform(
                ClientCalls.futureUnaryCall(newClientCall(client), inner.build()),
                mapResponse::apply);
    }
    ...
    private static final class ResponseObserver implements StreamObserver<Response> {
        ...
        private ResponseObserver(
                Function<Response, Void> onResponse, Function<Throwable, Void> onError) {
