...
class HederaKeySignatureListTest {
	...
	void testKeyListInit() {
		HederaKeySignature key1 = new HederaKeySignature(KeyType.ECDSA384, new byte[] {12,34,56}, new byte[] {12,34}, "ECDSA");
		HederaKeySignature key2 = new HederaKeySignature(KeyType.ED25519, new byte[] {78,90,12}, new byte[] {12,34}, "ED25519");
		...
		masterKeyList.addKeySignaturePair(KeyType.RSA3072, new byte[] {23, 45, 22}, new byte[] {12,34});
	...
	void HederaKeySignatureListSetArrays() { 
		...
		sigList.addKeySignaturePair(new HederaKeySignature(KeyType.ECDSA384, aKey1, null));
