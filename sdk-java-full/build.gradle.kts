...
val sdkSrcMainProto = layout.projectDirectory.dir("../sdk-java/src/main/proto")
val sdkSrcMainJava =
    layout.projectDirectory.dir("../sdk-java/src/main/java").asFileTree.matching {
        exclude("module-info.java")
    }
val sdkSrcMainResources = layout.projectDirectory.dir("../sdk-java/src/main/resources")
